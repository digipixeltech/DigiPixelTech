  ...
  return (
    <>
      <div className="bg-img-projects bg-[url('img/banner/Project.png')] font-serif w-full h-150 bg-cover flex flex-col justify-center leading-normal gap-2">
        ...
        <p className="ml-10">
          An overview of the projects which successfully designed and developed.
        </p>
      </div>
      ...
      <div className="font-serif">
        ...
        <div className="m-5">
          <div>
            <img src={Restaurant} className="w-200 flex justify-self-center" alt="" />
            {/* <Link
              to="https://haseeb-interior.netlify.app/"
              target="_blank"
          ...
          <div className="w-full text-center mt-8 mr-10">
            ...
            <p>
              ...
              Exercitationem cum ea, odio quibusdam nulla amet culpa dolores
              ratione fugiat aperiam ipsa accusamus fuga vel mollitia neque nemo
              commodi fugit tenetur libero! Deserunt dolor minus beatae tempora
              atque facilis ea recusandae, porro maxime. Magni architecto
              deserunt aspernatur quo sit assumenda. Earum quas ad velit aliquam
              odit asperiores quo et! Ipsa corporis voluptate veniam, id
              repudiandae adipisci quam rem odio eum sed nesciunt natus quas
              earum omnis consequatur suscipit facere beatae voluptates sunt
              impedit
            </p>
          </div>
        </div>
