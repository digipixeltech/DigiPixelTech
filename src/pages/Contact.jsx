...
const Contact = () => {
  return (
    <div className=" text-black h-150 m-20 p-20 flex justify-center bg-purple-600">
      <form onSubmit={() => {}} className="flex flex-col justify-center items-center w-180 bg-white  rounded-2xl">
        ...
        />
        <button className="py-2 px-4 bg-purple-500 rounded-2xl">Submit</button>
      </form>
    </div>
  );
};
